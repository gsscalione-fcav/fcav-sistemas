...
--*     
--* Finalidade: Consulta histórico academico dos alunos.     
...
SELECT  
    ...
    ELSE
		CASE WHEN MA.PERC_PRESFIM IS NULL THEN 
					 CONVERT(decimal(10, 2), 100-(dbo.fnObtemFaltasAluno (AL.ALUNO, MA.DISCIPLINA, MA.TURMA, MA.ANO, MA.SEMESTRE, 0) 
											/ dbo.fnObtemAulasPrevistas(AL.ALUNO, MA.DISCIPLINA, MA.TURMA, MA.ANO, MA.SEMESTRE))*100 )
			 ELSE
					CONVERT(decimal(10, 2), MA.PERC_PRESFIM * 100)   
		END
 END AS FREQUENCIA  
FROM LY_ALUNO AL  
