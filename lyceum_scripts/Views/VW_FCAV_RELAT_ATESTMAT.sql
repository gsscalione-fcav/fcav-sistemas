...
SELECT * FROM VW_FCAV_RELAT_ATESTMAT WHERE aluno in ('E201830070') order by aluno, ano, semestre  
...
INNER JOIN LY_ALUNO AL ON VW.ALUNO = AL.ALUNO 
INNER JOIN LY_PESSOA PES ON AL.PESSOA = PES.PESSOA  
INNER JOIN LY_CURSO CURSO ON AL.CURSO = CURSO.CURSO AND CURSO.FACULDADE NOT IN ('PALES')
