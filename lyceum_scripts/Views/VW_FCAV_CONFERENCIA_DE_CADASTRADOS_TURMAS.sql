...
SELECT
	...
	VT.DT_INICIO AS DT_INI_TURMA,
	VT.DT_FIM AS DT_FIM_TURMA,
    TU.ANO,
    TU.SEMESTRE,
    TU.FACULDADE AS  UNID_FISICA,
    TU.DISCIPLINA AS TUR_DISCIPLINA,
    TU.DT_INICIO AS DT_INI_DISCIPLINA,
    TU.DT_FIM AS DT_FIM_DISCICPLINA,
    TU.SERIE,
    TU.SIT_TURMA,
    TU.CLASSIFICACAO,
    TU.AULAS_PREVISTAS,
