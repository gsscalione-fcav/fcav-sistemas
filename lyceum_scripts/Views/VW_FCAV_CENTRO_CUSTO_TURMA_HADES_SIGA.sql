...
SELECT    
 T.TURMA,    
 (SELECT TOP 1 T2.CLASSIFICACAO FROM LY_TURMA T2 WHERE T2.TURMA = T.TURMA AND (T2.SERIE = 1 OR T2.SERIE = 0) ) AS SIT_TURMA,     
