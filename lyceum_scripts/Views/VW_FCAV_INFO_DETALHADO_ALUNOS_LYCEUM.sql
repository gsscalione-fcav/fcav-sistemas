...
VIEW VW_FCAV_INFO_DETALHADO_ALUNOS_LYCEUM

FINALIDADE: VIEW PARA TRAZER OS DADOS DOS ALUNOS DO LYCEUM NA PLANILHA DE Informações Detalhadas dos Alunos do Lyceum.xlsx

Autor: Gabriel Serrano Scalione
Data: 2021-01-11 11:25:39.137
...
IF EXISTS (SELECT * 
           FROM   sys.VIEWS 
           WHERE  NAME = 'VW_FCAV_INFO_DETALHADO_ALUNOS_LYCEUM') 
  DROP VIEW VW_FCAV_INFO_DETALHADO_ALUNOS_LYCEUM

go 

  
CREATE VIEW VW_FCAV_INFO_DETALHADO_ALUNOS_LYCEUM
AS  
