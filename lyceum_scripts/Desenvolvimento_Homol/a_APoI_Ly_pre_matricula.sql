...
-------------------------------------------------------------
	-- CONTROLE DE INSCRICAO PARA CURSO A-GPMP
	      IF (@v_CURSO = 'A-GPMP')    
			BEGIN    
				...
				BEGIN
					...
					SET @mensagem =    
						 'Informativo:       
							...
							<br><br>      
							O período de inscrições dessa turma, com o número de oferta: '+ CAST( @oferta AS VARCHAR) +' foi encerrada automaticamente no Lyceum.
							<br><br>
							Por favor entrar em contato com a TI-Sistemas para encerrar as inscrições também no site da Vanzolini se necessário.
							<br>
							Contato: 3024-2282
							<br><br>          
						'
