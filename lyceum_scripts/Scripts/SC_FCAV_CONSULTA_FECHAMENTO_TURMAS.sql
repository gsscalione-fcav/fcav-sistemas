...
AS(
	...
	WHERE
		YEAR(DT_INICIO) BETWEEN 2016 and 2017
	GROUP BY 
		TURMA,
		ALUNO,
		VALOR_CONTRATADO
...
(
	...
	WHERE SIT_ALUNO != 'Cancelado'
		  AND VALOR_PAGO > 0
		  and YEAR(DT_INICIO) BETWEEN 2016 and 2017
	GROUP BY 
		TURMA,
		ALUNO
)
...
SELECT 
	...
	DM.REALIZACAO,
	isnull((SELECT  
        SUM(CAST(VS.CUSTO_UNITARIO AS money))  
    FROM VW_FCAV_VALOR_OFERTA_CURSO VS  
