     /* ----------------------------------------------------------------------------    
		...
		SELECT * FROM #il_ic WHERE cobranca = 47274
		...
		*/
        ...
        BEGIN
            ...
            INNER JOIN (SELECT il.COBRANCA,
						...
						WHERE ld.LANC_DEB IS NOT NULL
							AND il.CODIGO_LANC IS NOT NULL
            ...
            BEGIN
                ...
                INSERT INTO #IL_IC
                    ...
                    --AND DESCRICAO NOT LIKE 'Diferença:%'
                    AND VALOR IS NOT NULL
                    GROUP BY COBRANCA
