...
WHERE
    ZZCRO_HIST.TABELA IN ('LY_ITEM_LANC') -- TABELA A SER CONSULTADA
...
--AND ZZCRO_HISTTRANS.ID in (4461479)
AND (ZZCRO_HISTCAMPO.ValorPos LIKE ('216244') OR ZZCRO_HISTCAMPO.ValorAnt LIKE ('216244')) -- VALOR DO CAMPO
