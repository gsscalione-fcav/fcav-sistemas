...
--*		17/02/2020 - Ajuste da parte que traz o nome, pois não estava trazendo o nome de cobranças que eram acordo. Gabriel.
--*    
--* ***************************************************************    

Declare  @p_boleto_cobranca   T_NUMERO,
 @p_descricao         T_ALFAEXTRALARGE
...
set @p_boleto_cobranca = 190689
    ...
    BEGIN -- Identificação se houve desconto para exibição na descriçao da nota ----	
		IF EXISTS (
					SELECT 1
    ...
    SET    
        @p_descricao =    
           ...
           '|' +    
            ...
            --    
            '|' +    
            'IMUNE A IMPOSTOS DE ACORDO COM O ART. 150, INC. VI, ALÍNEA C DA CONSTITUIÇÃO FEDERAL, ART.9, INC. VI, ALÍNEA C DO CÓDIGO TRIBUTÁRIO NACIONAL E ART. 181  DO REGULAMENTO DO IMPOSTO DE RENDA (RIR/2018).'    
