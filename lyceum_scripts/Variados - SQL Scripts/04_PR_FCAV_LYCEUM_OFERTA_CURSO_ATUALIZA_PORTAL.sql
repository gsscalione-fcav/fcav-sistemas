IF EXISTS(SELECT * FROM SYS.procedures WHERE name = 'PR_FCAV_LYCEUM_OFERTA_CURSO_ATUALIZA_PORTAL')
...
CREATE PROCEDURE dbo.PR_FCAV_LYCEUM_OFERTA_CURSO_ATUALIZA_PORTAL(
	...
	BEGIN
		...
		SELECT @encaminha_email =
				...
				CASE
				    ...
				    WHEN (UNIDADE_RESPONSAVEL = 'ATUAL' OR UNIDADE_RESPONSAVEL = 'PALES') AND FACULDADE = 'Paulista'
