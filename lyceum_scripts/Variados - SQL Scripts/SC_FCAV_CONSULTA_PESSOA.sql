...
SELECT DISTINCT
	*
FROM 
	#TMP_CANDIDATO_ALUNO TCA
	INNER JOIN VW_FCAV_RESUMO_MATRICULA_E_PRE_MATRICULA MA
	ON	MA.ALUNO = TCA.INSCRITO
	AND MA.TURMA = TCA.TURMA
WHERE TCA.INSCRITO = 'A201700369'
...
SET @pessoa		 = NULL
SET @nome_pessoa = '%Agnaldo Souza Zarate%'
SET @cpf		 = NULL --'22582432816'
SET @e_mail		 = null --'gabriel.scalione@vanzolini.org.br'
SET @candidato	 = NULL
SET @aluno		 = null --'E201510311'
...
LEFT JOIN LY_OFERTA_CURSO OC
	ON OC.OFERTA_DE_CURSO = TCA.OFERTA_DE_CURSO
