        ...
        BEGIN
            INSERT INTO LY_EMAILS_BATCH
                SELECT
                    ...
                    'gestao.cursos@vanzolini.org.br' INSTITUICAO_EMAIL,
                    'vanzolini.org.br' DOMINIO_ORIGEM,
                    'gestao.cursos' EMAIL_LOGIN,
                    dbo.crypt('$]Oz65mB_Pl') EMAIL_SENHA,
                    'N' ENVIADA,
                    GETDATE() DATA,
                    '10.200.43.69' IP_LOCAL,   --Na base de teste colocar o IP 10.200.43.174                      
                    'N' E_DOCENTE,
                    160 TEMPO_TIMEOUT,
                    587 PORTA,
                    5 NUMERO_TENTATIVAS,
